"""
Django settings for proyectdjango project.
...
SECRET_KEY = 'django-insecure-mpi1z7##7c2vv%ukukx)f46xvlk+4f5rk20-an16vf7f+!+*39'
...
# Eliminamos esta línea duplicada
WSGI_APPLICATION = 'tthhproject.wsgi.application'  # Corregido
# Database
...
USE_I18N = True
USE_TZ = True
LOGIN_URL = 'login'  # URL completa comenzando con barra
...
# Lista de URLs exentas de requerir login (opcional)
LOGIN_EXEMPT_URLS = [
    '/login/',
    '/admin/login/',
    '/static/',
    '/media/',
    '/signup/',
    # Agrega aquí otras URLs que no requieran autenticación
]
